...
var getGlobbedPaths = function (globPatterns, excludes) {
  ...
  output.sort(function (a, b) {
    //console.log('Comparing a&b&depthA&depthB', a, b, depthA, depthB);
...
var initGlobalConfigFiles = function (config, assets) {
  ...
  config.files.client.js = getGlobbedPaths(assets.client.lib.js).concat(getGlobbedPaths(assets.client.js));
  //config.files.client.js = getGlobbedPaths(assets.client.lib.js, 'public/').concat(getGlobbedPaths(assets.client.js, ['public/']));

  // Setting Globbed css files
  config.files.client.css = getGlobbedPaths(assets.client.lib.css).concat(getGlobbedPaths(assets.client.css));
